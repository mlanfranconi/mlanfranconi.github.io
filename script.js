document.addEventListener("DOMContentLoaded", function() {
    ...
    const translations = {
        es: {
            ...
            feature6_text: "Estoy ahí, paso a paso, <em>desde la logística hasta la ejecución y la medición.</em> Antes, durante y después, ofreciendo soporte y cuidando cada detalle para que todo salga perfecto.",
        ...
        en: { 
            ...
            feature6_text: "I'm there, step by step, <em>from logistics to execution and measurement.</em> Before, during, and after, offering support and taking care of every detail to ensure everything goes perfectly.",
